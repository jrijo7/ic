...
beta_chain = array(0, dim = c(K, V, n_iter/100) )
theta_chain = array(0, dim = c(D, K, n_iter/100) )
z_chain = rep(list(0), n_iter/100)
...
# save
save(mcmc_chain, file = "C:/Users/joaov/Documents/IC/bbcsport/mcmc_output/mcmc_chain.Rdata")

# load mcmc chain
load(file = "C:/Users/joaov/Documents/IC/bbcsport/mcmc_output/mcmc_chain.Rdata")
